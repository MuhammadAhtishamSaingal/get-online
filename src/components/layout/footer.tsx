  ...
  return (
    <footer className="bg-black text-white border-t border-neutral-900">
      <div className="mx-auto max-w-7xl px-6 py-12 sm:px-10 lg:px-16 lg:py-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 pb-12 border-b border-neutral-900">
          ...
          >
            <input
              ...
              className="flex-1 bg-neutral-950 border border-neutral-800 text-sm px-4 py-2.5 text-white placeholder:text-neutral-600 focus:outline-none focus:border-neutral-500 transition-colors rounded-none"
            />
            <button
              type="submit"
          ...
          {/* Social Links (Custom SVG Vectors matching Spigen style) */}
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/" className="text-[13px] text-neutral-400 hover:text-white transition-colors duration-300">
                  Our Story
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/policies/privacy" className="text-[13px] text-neutral-400 hover:text-white transition-colors duration-300">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/policies/terms" className="text-[13px] text-neutral-400 hover:text-white transition-colors duration-300">
                  Terms of Service
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link href="/admin/login" className="text-[13px] text-neutral-400 hover:text-white transition-colors duration-300">
                  My Account
                </Link>
              </li>
              <li>
        ...
        {/* Bottom Bar: Copyright & Cookie Button Details */}
        <div className="mt-16 pt-8 border-t border-neutral-900 flex items-center justify-between">
          <p className="text-[11px] text-neutral-500 tracking-wider">
            &copy; {new Date().getFullYear()} GizmoGrid, Inc. All Rights Reserved.
          </p>

          {/* Premium Cookie Toggle button */}
          <div 
            onClick={() => alert("Cookie settings panel simulation activated.")}
            className="h-10 w-10 bg-white rounded-full flex items-center justify-center shadow-lg cursor-pointer hover:scale-110 active:scale-95 transition-transform"
