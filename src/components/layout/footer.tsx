  ...
  return (
    <footer className="bg-black text-white border-t border-neutral-900">
      <div className="mx-auto max-w-7xl px-6 py-12 sm:px-10 lg:px-16 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12 pb-12 border-b border-neutral-900">
        ...
        {/* Bottom Bar: Copyright & Social Links & Cookie Toggle button */}
        <div className="mt-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Social Icons & Cookie Button (Footer Right side) */}
